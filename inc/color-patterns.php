 ...
 */
function joshadamboyd_custom_colors_css() {
  $hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

  /**
   * Filter Josh Adam Boyd default saturation level.
   *
   * @since Josh Adam Boyd 1.0
   *
   * @param int $saturation Color saturation level.
   */
  $saturation = absint( apply_filters( 'joshadamboyd_custom_colors_saturation', 50 ) );
  $reduced_saturation = ( .8 * $saturation ) . '%';
  $saturation = $saturation . '%';
  $css = '
/**
 * Josh Adam Boyd: Color Patterns
 *
...
.colors-custom.page:not(.joshadamboyd-front-page) .entry-title,
...
.colors-custom .joshadamboyd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.joshadamboyd-front-page .panel-content .recent-posts article,
...
.colors-custom.joshadamboyd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
  ...
  /**
   * Filters Josh Adam Boyd custom colors CSS.
   *
   * @since Josh Adam Boyd 1.0
   *
   ...
   */
  return apply_filters( 'joshadamboyd_custom_colors_css', $css, $hue, $saturation );
}
